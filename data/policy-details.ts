  ...
  },
  {
    ...
    detailedOptions: [
      ...
      },
      {
        ...
        disadvantage:
          "Requires additional resources and potentially challenges curriculum implementation due to diverse language demands.",
      },
    ],
  },
  {
    ...
    detailedOptions: [
      {
        id: 1,
        title: "Minimal teacher training",
        ...
        disadvantage:
          "Limits teachers' ability to effectively address the unique needs and challenges of refugee students, potentially resulting in a lack of understanding and support.",
      },
      {
        id: 2,
        ...
        disadvantage:
          "May not fully equip teachers to address complex challenges or provide comprehensive support for refugee students.",
      },
      {
        id: 3,
        ...
        disadvantage:
          "Requires substantial investment in training programs and ongoing professional development for teachers.",
      },
    ],
  },
  {
    ...
    detailedOptions: [
      ...
      },
      {
        ...
        disadvantage:
          "May not fully address the specific educational and cultural needs of refugee students or provide comprehensive representation.",
      },
      {
        id: 3,
        ...
        disadvantage:
          "Requires substantial curriculum redesign and ongoing updates to incorporate diverse perspectives, potentially posing logistical challenges.",
      },
    ],
  },
  {
    ...
    detailedOptions: [
      {
        id: 1,
        title: "Limited psychosocial support",
        description: "Provide limited or no specific psychosocial support for refugee students.",
        advantage:
          "Reduces immediate financial and resource burdens associated with providing dedicated psychosocial support.",
        disadvantage:
          "Negatively impacts the mental health and well-being of refugee students, potentially hindering their educational success.",
      },
      {
        id: 2,
        ...
        disadvantage:
          "May require additional resources and trained personnel to effectively implement and maintain support services.",
      },
      {
        id: 3,
        ...
        disadvantage:
          "Requires significant investment in resources, trained professionals, and ongoing support services to ensure effectiveness.",
      },
    ],
  },
  {
    ...
    detailedOptions: [
      ...
      },
      {
        ...
        disadvantage:
          "May not fully address the financial needs and complexities associated with providing a comprehensive education for refugees.",
      },
      {
        id: 3,
        ...
        disadvantage:
          "Requires a substantial financial commitment and potentially reallocating resources from other areas of the budget.",
      },
    ],
  },
  {
    ...
    detailedOptions: [
      {
        ...
        disadvantage:
          "Disregards the educational background and qualifications obtained by migrants, potentially overlooking valuable skills and knowledge.",
      },
      {
        id: 2,
        ...
        disadvantage:
          "Requires additional resources, expertise, and time to evaluate and assess the diverse educational backgrounds of migrants.",
      },
      {
        id: 3,
        ...
        disadvantage:
          "Requires additional resources and coordination to design and implement tailored programs, potentially leading to logistical challenges.",
      },
    ],
  },
]
